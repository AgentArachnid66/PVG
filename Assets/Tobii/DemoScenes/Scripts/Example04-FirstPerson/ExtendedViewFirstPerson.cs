...
public class ExtendedViewFirstPerson : ExtendedView
{
	...
	public override void AimAtWorldPosition(Vector3 worldPostion)
	{
		...
		InitAimAtGazeOffset(Mathf.DeltaAngle(desiredRotation.eulerAngles.y, CameraWithExtendedView.transform.rotation.eulerAngles.y),
		    Mathf.DeltaAngle(desiredRotation.eulerAngles.x, CameraWithExtendedView.transform.rotation.eulerAngles.x));
